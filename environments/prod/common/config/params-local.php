<?php
return [
    'project_id' => 'MARKET_EXE_SYS_PROD',
    'h5key' => 'lingmou',
    'baidumap' => [
    ...
    'ding' => [
        ...
        'access_token' => '216908815025ee03546e6f68f84d21e03184c895fae955bf598da9df7563a5e1',
        'secret' => 'SEC40ca95c0d0cd64188890d0c8a5317b7220c8e66c94be7776e443b072483dab60',
    ],
    // 整改上传的sftp
    'sftp' => [
        'host' => 'sftp-server.smartmedire.com',
        'username' => 'rectify',
        'password' => 'EFgiRDql',
        'port' => '2229',
    ],
    'store_sftp' => [
        'customer' => [
            'host' => 'sftp.smartmedire.com',
            'username' => 'swire_custom_full',
            'password' => 'GABWtcFd',
            'port' => '2229'
        ],
        'equipment' => [
            'host' => 'sftp.smartmedire.com',
            'username' => 'swire_equipment',
            'password' => 'ZMWhx6U0',
            'port' => '2229'
        ]
    ],
    'tools' => [
        'update_question' => 'http://sea-api.lingmouai.com/updateQuestion'
    ],
    ...
    'distinguish_callback' => 'https://swire-check-system-api.lingmouai.com/api/receive/recognition-result',
    'similarity_callback' => 'https://swire-check-system-api.lingmouai.com/api/receive/similarity-image',
    'open_similarity' => true,
    'url' => [
        'ir_sku_host' => 'http://engine-sku-api.lingmouai.com/',
        'media_host' => 'http://snapshot-swire-medi.lingmouai.com/',
        'rule_host' => 'http://rule-engine-api.lingmouai.com/',
//        'rule_web' => 'http://rule-engine.lingmouai.com/',
        'rule_web' => 'https://rule-engine.lingmouai.com/',
//        'smart_medi_host' => 'http://dev2.ficent.com:9888/',
    ],
    'swire_user' => [
        'url' => 'http://mes-url.lingmouai.com',
    ...
    'zft_url' => 'https://zftapi.app.swirebev.com:8443',                 // zft接口地址
    'swire_function_map' => 'SWIRE_FUNCTION_MAP',
    'swire_user_info' => 'USER_TOKEN_',
    'media_key' => 'swireIne2020',
    'cp_url' => 'http://cp-api.lingmouai.com/receive/auditResult',
    'new_cp_url' => 'http://cp-api.lingmouai.com/receiver/auditResult',
    'queue_store_check_task_id_uid' => 'QUEUE_STORE_CHECK_TASK_ID_UID_',
    'zft_api_key' => '661ADA5EF0B2CE271D908A1EE836E64C',
    'engine_calculation' => [
        'engine_0' => 'ENGINE_INPUT_PROD_0',
        'engine_1' => 'ENGINE_INPUT_PROD_1'
    ],
    ...
    'sea_url'=>'http://sea-plus.lingmouai.com/sea',
];