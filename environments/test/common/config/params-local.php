<?php
return [
    'project_id' => 'MARKET_EXE_SYS_TEST',
    'h5key' => 'lingmou',
    'baidumap' => [
    ...
    'tools' => [
        'update_question' => 'http://49.234.34.77:10080/updateQuestion'
    ],
    ...
    'distinguish_callback' => 'http://swire-check-system-api-test.lingmou.ai:8032/api/receive/recognition-result',
    'similarity_callback' => 'http://swire-check-system-api-test.lingmou.ai:8032/api/receive/similarity-image',
    'open_similarity' => true,
    'url' => [
        'ir_sku_host' => 'http://engine-sku-test.lingmou.ai:8090/',
        'media_host' => 'http://snapshot-swire-medi.lingmou.ai:8032/',
        'rule_host' => 'http://rule-engine-api-test.lingmou.ai:8032/',
//        'rule_web' => 'http://rule-engine-test.lingmou.ai:8032/',
        'rule_web' => 'https://rule-engine-test.lingmou.ai:4432/',
//        'smart_medi_host' => 'http://dev2.ficent.com:9888/',
    ],
    'swire_user' => [
        'url' => 'http://49.234.34.77:10070',
...
//    'zft_url' => 'http://dev2.ficent.com:9888',                 // zft接口地址
    ...
    'cp_url' => 'https://mes-backend-api-test.lingmouai.com/receiver/auditResult',
//    'new_cp_url' => 'http://wjy.zwjk.com/receiver/auditResult',
    'new_cp_url' => 'https://mes-backend-api-test.lingmouai.com/receiver/auditResult',
    'queue_store_check_task_id_uid' => 'QUEUE_STORE_CHECK_TASK_ID_UID_',
    'zft_api_key' => '48392f24a3d76b5a9ffd613',
    'engine_calculation' => [
        'engine_0' => 'ENGINE_INPUT_TEST_0',
        'engine_1' => 'ENGINE_INPUT_TEST_1'
    ],
    'sea_url'=>'http://sea-plus-test.lingmouai.com/sea',
