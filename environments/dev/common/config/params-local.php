...
return [
    ...
    'distinguish_callback' => 'http://swire-check-system-api-dev.lingmou.ai:8031/api/receive/recognition-result',
    'similarity_callback' => 'http://swire-check-system-api-dev.lingmou.ai:8031/api/receive/similarity-image',
    'open_similarity' => true,
    'url' => [
        'ir_sku_host' => 'http://engine-sku-test.lingmou.ai:8090/',
        'media_host' => 'http://snapshot-swire-medi.lingmou.ai:8032/',
        'rule_host' => 'http://rule-engine-api-dev.lingmou.ai:8031/',
//        'rule_web' => 'http://rule-engine-dev.lingmou.ai:8031/',
        'rule_web' => 'https://rule-engine-dev.lingmou.ai:4431/',
...
//        'url' => 'https://0d572b74-6cb6-4dca-ada5-4772abcc4745.mock.pstmn.io',
        'account' => 'medi@swirebev.com',
        'api-key' => 'YnrIUtEaSXCJQ39SqE4VHh50-gzGzoHsz',
        'user_function_list_queue' => 'USER_FUNC_LIST_'        // 用户权限列表 USER_FUNC_LIST_30060001 后面加user表太古token
    ],
//    'zft_url' => 'http://dev2.ficent.com:9888',                 // zft接口地址
    ...
    'cp_url' => 'http://49.234.34.77:9091/receive/auditResult',
    'queue_store_check_task_id_uid' => 'QUEUE_STORE_CHECK_TASK_ID_UID_',
    'zft_api_key' => '48392f24a3d76b5a9ffd613',
    'engine_calculation' => [
        'engine_0' => 'ENGINE_INPUT_DEV_0',
        'engine_1' => 'ENGINE_INPUT_DEV_1'
    ],
